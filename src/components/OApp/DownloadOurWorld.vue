...
<template>
  <div class="p-shell">
    ...
    <p class="p-body">Download Our World to run it locally and develop OAPPs against a local OASIS node. Includes the full OASIS API runtime and development tools.</p>
    <div class="p-size">Estimated size: <strong>4.2 GB</strong></div>
    <div class="p-actions">
