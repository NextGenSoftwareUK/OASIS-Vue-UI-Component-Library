...
<template>
  <div class="p-shell">
    ...
    <h2 class="p-title">Manage OAPP</h2>
    <p class="p-body">Advanced OAPP management tools are coming soon — configure permissions, update dependencies, manage subscriptions, and monitor usage analytics.</p>
