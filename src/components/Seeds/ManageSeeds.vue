...
<template>
  <div class="p-shell">
    ...
    <p class="p-body">SEEDS management tools are coming soon — view your balance, transaction history, trusted connections and regenerative impact score all in one place.</p>
