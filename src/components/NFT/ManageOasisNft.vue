...
<template>
  <div class="p-shell">
    ...
    <h2 class="p-title">Manage OASIS NFT</h2>
    <p class="p-body">NFT management tools are coming soon — mint, transfer, burn and list your OASIS NFTs across multiple blockchain providers.</p>
